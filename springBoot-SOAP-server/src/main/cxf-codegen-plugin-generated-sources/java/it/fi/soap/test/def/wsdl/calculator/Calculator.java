...
public class Calculator extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/home/francesco/repositories/github/springBoot-SOAP-client-server/springBoot-SOAP-server/src/main/resources/wsdl/calculator-wsdl.asmx");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(Calculator.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "file:/home/francesco/repositories/github/springBoot-SOAP-client-server/springBoot-SOAP-server/src/main/resources/wsdl/calculator-wsdl.asmx");
        }
        WSDL_LOCATION = url;
    }
