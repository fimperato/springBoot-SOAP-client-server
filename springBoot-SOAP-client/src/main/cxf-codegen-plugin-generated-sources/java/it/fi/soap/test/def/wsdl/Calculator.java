 ...
 * 2022-04-25T09:55:36.071+02:00
 * Generated source version: 3.4.2
 *
 */
@WebServiceClient(name = "Calculator",
                  wsdlLocation = "file:/home/francesco/repositories/github/springBoot-SOAP-client-server/springBoot-SOAP-client/src/main/resources/wsdl/calculator-wsdl.asmx",
                  targetNamespace = "http://calculator.wsdl.def.test.soap.fi.it/calculatorDef/")
public class Calculator extends Service {

    public final static URL WSDL_LOCATION;

    public final static QName SERVICE = new QName("http://calculator.wsdl.def.test.soap.fi.it/calculatorDef/", "Calculator");
    public final static QName CalculatorSoap12 = new QName("http://calculator.wsdl.def.test.soap.fi.it/calculatorDef/", "CalculatorSoap12");
    public final static QName CalculatorSoap = new QName("http://calculator.wsdl.def.test.soap.fi.it/calculatorDef/", "CalculatorSoap");
    static {
        URL url = null;
        try {
            url = new URL("file:/home/francesco/repositories/github/springBoot-SOAP-client-server/springBoot-SOAP-client/src/main/resources/wsdl/calculator-wsdl.asmx");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(Calculator.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "file:/home/francesco/repositories/github/springBoot-SOAP-client-server/springBoot-SOAP-client/src/main/resources/wsdl/calculator-wsdl.asmx");
        }
        WSDL_LOCATION = url;
    }
